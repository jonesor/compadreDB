...
**Definition:** Country(ies) in which the population is located. We use ISO 3 three letter country codes (https://en.wikipedia.org/wiki/ISO_3166-1_alpha-3). If the population is simulated or comprised of data from multiple countries ('FRANK'), 'NA' is used 

##### Possible values:

* `<ISO 3 country code(s)>` -	e.g. `DEU` for a study carried out in Germany

* `FRANK` - The population is comprised of data from various sources (these may be wild or lab populations as well as simulations). Country codes (if known) may be included in addition to 'FRANK'

* `LAB` - The population is simulated or comprised of data from multiple countries

* `Simulation` - The population is simulated or comprised of data from multiple countries
