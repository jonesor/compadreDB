...
**Definition:** Whether the matrix is seasonal or not.
...
**Definition:** Sampling census authors used.
...
**Definition:** Maximum stage-specific survival value in the matrix population model submatrix U. Values >1 may indicate an issue in a U matrix.
