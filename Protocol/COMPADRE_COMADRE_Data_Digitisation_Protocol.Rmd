...
* Latin names of species for variable "SpeciesAccepted" must be checked using reliable sources (e.g. Catalogue of Life http://www.catalogueoflife.org/, Wikipedia  https://en.wikipedia.org/) for spelling mistakes. If an author uses a Latin name with a typo, please leave it as is, as the variable "SpeciesAuthor" (below) represents the name as used by the authors.
...
* DOI.ISBN
* Ecoregion
* GrowthFormRaunkiaer (only relevant for COMPADRE)
* Purposes
* StudyDuration
* AnnualPeriodicity
* MatrixStartYear
...
For further information see https://en.wikipedia.org/wiki/Raunkiær_plant_life-form.
