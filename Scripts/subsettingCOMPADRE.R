#Set your working directory, then load the COMPADRE data:
load("COMPADRE Jul 21 2014.RData")

#Subsetting to data of interest:
#I want to look at the mean matrrices for shrubs that are from studies that are 5+ years long, with a dimension of 5+.
#I first use subset() to subset the metadata part of the compadre object to rows that match myn criteria. 
...
#I could analyse these matrices by using a loop, or by using lapply.
