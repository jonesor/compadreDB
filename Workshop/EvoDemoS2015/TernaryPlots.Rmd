...
```{r, comment=">"}
tempMetadata <- subset(comadre$metadata, MatrixDimension >= 3 & MatrixComposite == "Mean" & MatrixTreatment == "Unmanipulated" & StudyDuration > 3 & MatrixFec == "Yes" & MatrixSplit == "Divided" & SurvivalIssue < 1)
```
...
ternaryplot(output[,c("R","S","G")],scale=1,col=alpha("gray80",0.7),bg="black", dimnames=c("Stasis","Growth","Reproduction"),dimnames_position="edge", main="Preliminary plot")
```
